...
class TT_Example_List_Table extends WP_List_Table {
        ...
        switch($column_name){
           /* case 'id':
            ...
            case 'receiver_name':
                ...
                break;
            case 'status':
                $status = ($item[$column_name] == 1) ? 'Success' : 'Failed' ;
                return $status;
                break;
            case 'card':
                 return '<img width="100" src="'.$item[$column_name].'">';
                break;
            case 'gif1':
                return '<img width="100" src="'.$item[$column_name].'">';
                break;
            case 'gif2':
                $gif2 = ($item[$column_name]) ? '<img width="100" src="'.$item[$column_name].'">' : ' - ' ;
                return $gif2;
                 break;
            case 'date_created':
                return $item[$column_name];
    ...
    function prepare_items() {
        global $wpdb; //This is used only if making any database queries
         $querystr = "SELECT * FROM gif_orders ORDER BY id DESC";
...
function tt_add_menu_items(){
    add_menu_page('Card orders', 'Orders', 'activate_plugins', 'tt_list_test', 'tt_render_list_page');
