        ...
        function slr_login_shortcode(){
            ...
            $output  = '<div class="slr-login-from-wrap ">
                            <form class="forms" method="post" id="slr_login_form">
                                <fieldset>
                                   <section>
                                       <input type="text" name="slr_user_login" class="width-6" placeholder="username"  />
                                    </section>
                                    <section>
                                        <input type="password" name="slr_user_password" class="width-6" placeholder="Password"  />
                                    </section>
                                    <section class="rem-password">
								        <div><label class="checkbox">
								        <input type="checkbox" name="slr_rememberme" value="true"> Remember me</label><a href="'.site_url().'/reset-password" class="pull-right">Forgot Password</a></div>
        ...
        function slr_register_shortcode(){
            ...
            $output  = '<div class="slr-register-from-wrap">
                            ...
                            <section>
                                    ...
                                    <input placeholder="First Name" type="text" name="reg_fname" class="width-6" />
                                </section>
                                <section>
                                   
                                    <input placeholder="Last Name" type="text" name="reg_lname" class="width-6" />
                                </section>
                               
                                <section>
                                   
                                    <input placeholder="Email" type="email" name="reg_email" class="width-6" required/>
                                </section>
                                <section>
        ...
        {   
            ...
            if (is_wp_error($this->validation())) {
                ...
                if (!is_wp_error($register_user)) {
                    ...
                    $template = str_replace("{{username}}",esc_attr($this->email),$template);
                    $template = str_replace("{{password}}",$this->password,$template);
                    $headers = array('Content-Type: text/html; charset=UTF-8');
                    wp_mail($this->email, 'Welcome to GifGiftCard!', $template, $headers);
                } else {
