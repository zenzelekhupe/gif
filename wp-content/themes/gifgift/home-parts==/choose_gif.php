...
<div id="whole-gif">
	...
	<?php if ($gifs) { ?>
		<li class="active">
			<a data-toggle="tab" href="#mygifs">My GIF's</a>
		</li>
	<?php } ?>
	...
	<div class="tab-content">
 		<div class="tab-pane active" id="mygifs">
			...
			<div class="col-md-12 masonry">
					...
					<div class="nopadding">
					<input type="radio" value="<?php echo $gif; ?>" name="choose_gif" id="my-<?php echo $key; ?>" class="input-hidden choose_gif" />
						<label for="my-<?php echo $key; ?>"><img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" data-src="<?php echo wp_upload_dir()['baseurl'] ;?>/gif/<?php echo $gif;?>"></label>
					</div>
					<?php } ?>
       ...
       <!--  get well tab     -->
			...
			?>	
					<div class="nopadding">
					<input type="radio" value="<?php echo $friendship->gif->url; ?>" name="choose_gif" id="my-<?php echo $get_well->gif->url; ?>" class="input-hidden choose_gif" />
